        ...
        $.ajax(
            {
                ...
                success: function (result) {
                    if (result.status == 1) {
                        ...
                        $("#margerRole").val(result.data.role_id);
                    } else {
                ...
                <c:forEach items="${pageInfo.list}" var="sysUser">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${sysUser.is_valid==1}">有效</c:if>
                            <c:if test="${sysUser.is_valid==0}">无效</c:if>
                        </td>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <br>
                <div class="row text-right">
                    <label for="login_name" class="col-sm-4 control-label">登录帐号：</label>
                    <div class="col-sm-4">
