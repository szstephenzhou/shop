////////////////////////////////////////////////////
var _wsloading = false;  //记录ws是否已连接成功，可以点击开始播放按钮

var __WS__URL__ = "ws://127.0.0.1:17885";
var __WS_PARAM__ = "peergine-node";

var __ACTION_URL__ = "http://127.0.0.1:17885/peergine.do";
...
function pgLibJSNode(sSession) {
    ...
    this.omlEncode = function(sEle) {
        ...
        console.log("sParamJson  =  " + JSON.stringify(sParamJson))
    ...
    this.WndCreate = function(divId) {
        ...
        if (oDiv != null) {
            ...
            if (oImg == null) {
                ...
                oImg.id = divId + "_img";
                oImg.style = "width:100%;height:100%;";
...
//private
var _pgView = {
    url: "http://127.0.0.1:17885/video.do",
    ...
    imgonload: function(divid) {
        ...
        if (oDiv) {
            var oImg = document.getElementById(divid + "_img");
            //datuIMG(oview.oimg, oview.sizeX, oview.sizeY);
